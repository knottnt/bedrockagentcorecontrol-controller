...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/Harness"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("harnesses")
