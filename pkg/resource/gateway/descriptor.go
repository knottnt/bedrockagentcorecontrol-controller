...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/Gateway"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("gateways")
