...
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=gatewaytargets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrockagentcorecontrol.services.k8s.aws,resources=gatewaytargets/status,verbs=get;update;patch
