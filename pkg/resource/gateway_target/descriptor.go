...
const (
	FinalizerString = "finalizers.bedrockagentcorecontrol.services.k8s.aws/GatewayTarget"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("gatewaytargets")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.GatewayTarget{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.GatewayTarget),
	}
}
